...
struct first_fit_free_list_strategy
{
    constexpr free_list_node* allocate(free_list& list, size_t size);
    constexpr bool deallocate(free_list& list, memory_block& block);
};

constexpr free_list_node* first_fit_free_list_strategy::allocate(free_list& list, size_t size)
{
...
constexpr bool first_fit_free_list_strategy::deallocate(free_list& list, memory_block& block)
{
